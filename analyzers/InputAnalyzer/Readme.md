...
### InputAnalyzer.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [InputAnalyzer.Sample.csproj](../InputAnalyzer.Sample/InputAnalyzer.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 
