...
using Xunit;
using Verifier =
    Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<InputAnalyzer.SampleSyntaxAnalyzer,
        InputAnalyzer.SampleCodeFixProvider>;

namespace InputAnalyzer.Tests;
